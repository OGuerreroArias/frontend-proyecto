...
export default function Login() {
  ...
  const handleLogin = () => {
    ...
    console.log(
      "🚀 ~ file: index.tsx ~ line 74 ~ handleLogin ~ emailValue",
      emailValue
    );

    authService.getUserByEmail(emailValue).then((user) => {
      // console.log(
      //   "🚀 ~ file: index.tsx ~ line 64 ~ authService.getUserByEmail ~ user",
      //   user
      // );

      if(user.message) alert('Usuario no encontrado')
      else {
